...
# Paper-aligned MiLoRA (1.5B) settings for verl DAPO experiments.
# Required env vars for multi-job launch:
#   CUDA_VISIBLE_DEVICES, SEED, EXP_NAME, LOG_FILE

SEED=${SEED:-42}
EXP_NAME=${EXP_NAME:-milora_1p5b_paper_seed${SEED}}
LOG_FILE=${LOG_FILE:-./outputs/${EXP_NAME}.log}

PROJECT_NAME=${PROJECT_NAME:-MiLoRA-Paper-Replication}
...
# Use prepared MiLoRA SVD bundle (base + adapter must match).
MODEL_BASE_PATH=${MODEL_BASE_PATH:-./adapter_bundles/deepseek_r1_distill_qwen_1_5b/milora_r32_a32/base}
LORA_ADAPTER_PATH=${LORA_ADAPTER_PATH:-./adapter_bundles/deepseek_r1_distill_qwen_1_5b/milora_r32_a32/adapter}
